...
\begin{assignment}
	Please show the TA that your program starves the other functions. Make sure that your passoff gets recorded on the passoff spreadsheet!
\end{assignment}
...
\begin{assignment}
	Pass off this section with a TA to show that changing the priorities changes the way the LEDs function. Make sure that your passoff gets recorded on the passoff spreadsheet!
\end{assignment}
