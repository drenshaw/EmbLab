...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%                                                                                         %%%%
%%%%       Chapter 0: The STM32F072 Discovery and Toolchain                                  %%%%
%%%%                                                                                         %%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\section{Introduction to the Lab Layout}\index{Introduction to the Lab Layout}
...
\begin{exercise}[Example exercise ]
...
% The section locations for each question needs renumbering in respect to the section to which it refers
	\begin{enumerate}
		\item How much memory and FLASH storage does the STM32F072R8 have? %(section 1.2)
		\item What does the acronym "HAL" stand for? %(section 1.3) 
		\item What is the STM32CubeMX program used for? %(section 1.4)
		\item Why can't a "bare-metal" embedded application return from the main function? %(section 2.2)
		\item In the system's memory table, are the peripheral registers higher or lower in address than the SRAM? %(section 2.3)
		\item What information does each of the four main datasheets/manuals used in the labs provide? %(section 2.4)
		\item Why do STM32F0 devices not recognize inputs/outputs on a chip by physical pin numbering? %(section 2.4.1)
		\item What is the name of ST's header file that defines names for the peripheral registers? %(section 2.4.3)
		\item What bitwise operator would you use to set a bit in a register? %(section 2.5.1)
		\item What peripheral enables the system clock to other peripherals? %(section 2.5.2)
		\item What peripheral do the HAL library delay functions use? %(section 2.5.3)
		\item Why should you avoid floating-point values on an STM32F0? %(section 2.5.4)
	\end{enumerate}
\end{question}

\section{\color{orange}Introduction to the STM32F072 Discovery Board}\index{Introduction to the STM32F072 Discovery Board}
...
\section{\color{orange}ARM Development Toolchain}\index{ARM Development Toolchain}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%                                                                                         %%%%
%%%%       Chapter 1: Memory-Mapped Peripherals and the GPIO                                 %%%%
%%%%                                                                                         %%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapterimage{chapter_head_2.png} % Chapter heading image
...
\begin{question}[Postlab 1]
	...
	\begin{enumerate}
		...
		\begin{itemize}
			\item Use the chip datasheet, lab section 2.4.1 gives a hint to the location. You'll want to search the I/O AC characteristics table. You will also need to view the OSPEEDR settings to find the bit pattern indicating the slowest speed.
		\end{itemize}
